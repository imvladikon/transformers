...
def chunk_kimi_delta_attention(
    ...
    **kwargs,
    ...
    # Non-causal pairs give large positive differences that overflow exp() in float32 and yield nan
    # gradients, so they are masked to -inf beforehand. Strictly upper: the diagonal is used below.
